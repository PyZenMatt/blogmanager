...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='site',
            name='repo_path',
            field=models.CharField(blank=True, default='', help_text='Percorso working copy locale del repo Jekyll (se vuoto usa BLOG_REPO_BASE/<slug> se esiste)', max_length=255),
        ),
