...
REST_FRAMEWORK = {
    ...
    "PAGE_SIZE": 10,
    "EXCEPTION_HANDLER": "blog_manager.exceptions.custom_exception_handler",
}
...
LOGGING = {
    ...
    "loggers": {
        ...
        "django.db.backends": {"level": "WARNING"},  # evita log troppo verbosi
        "blog_manager.exceptions": {"level": "INFO"},
    },
}
