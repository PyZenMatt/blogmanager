...
@patch("blog.exporter._git_add_commit_push", return_value=True)
@patch("blog.exporter._safe_write", return_value=True)
...
@patch("blog.exporter._git_add_commit_push")
@patch("blog.exporter._safe_write")
